...
export default function Index() {
  ...
  return (
    <main className="bg-gradient-to-b from-background to-background">
      ...
      <section
        id="about"
        className="container grid gap-8 py-16 md:grid-cols-3 md:gap-12 md:py-24"
      >
        <div className="md:col-span-1">
          ...
          <p className="mt-2 text-muted-foreground">
            A bit of background, Is it interesting? I have no clue.
          </p>
        </div>
        <div className="md:col-span-2 space-y-4 text-muted-foreground">
          <p>I am T342! But my username is T342guy on almost all platforms!</p>
          <p>
            Im just some random dude strafing around the internet! Who woulda
            thought?
          </p>
          <p>
          ...
          <div className="grid gap-6 md:grid-cols-1">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  <p>
                    If you wanna contact me, go right ahead! I can respond when
                    I can!
                  </p>
                </CardDescription>
              </CardHeader>
          ...
          <section id="accounts" className="mt-12">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Card>
                <CardHeader>
                  <CardTitle className="inline-flex items-center gap-2">
                    <Twitter className="size-5 text-primary" /> X (Twitter)
                  </CardTitle>
                  <CardDescription>
                    <p>Just twitter. Also somehow a dumpsterfire.</p>
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <a
                    href="https://x.com/T342guy"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                  >
                    x.com/T342guy <ArrowRight className="size-4" />
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="inline-flex items-center gap-2">
                    <Gamepad className="size-5 text-primary" /> Steam
                  </CardTitle>
                  <CardDescription>
                    <p>
                ...
                <CardContent>
                  <a
                    href="https://steamcommunity.com/id/T342guy"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                  >
                    steamcommunity.com/id/T342guy{" "}
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="inline-flex items-center gap-2">
                    <Youtube className="size-5 text-primary" /> YouTube
                  </CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  <a
                    href="https://www.youtube.com/channel/UCC2PYQVdiFAwE5927TPuVlA"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                  >
                    youtube.com/channel/UCC2PYQVdiFAwE5927TPuVlA{" "}
                    <ArrowRight className="size-4" />
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="inline-flex items-center gap-2">
                    <Twitch className="size-5 text-primary" /> Twitch
                  </CardTitle>
                  <CardDescription>
                    <p>Live streams! If I ever get to them...</p>
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <a
                    href="https://www.twitch.tv/T342guy"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                  >
                    twitch.tv/T342guy <ArrowRight className="size-4" />
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <a
                    href="https://www.reddit.com/user/T342games"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                  >
                    reddit.com/user/T342games <ArrowRight className="size-4" />
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <a
                    href="https://github.com/T342guy"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
                  >
                    github.com/T342guy <ArrowRight className="size-4" />
                  </a>
                </CardContent>
              </Card>
            </div>
